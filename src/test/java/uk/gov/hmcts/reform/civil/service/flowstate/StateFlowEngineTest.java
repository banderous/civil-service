...
class StateFlowEngineTest {
    ...
    class EvaluateStateFlowEngine {
        ...
        /**
        @Test
        void shouldReturnAwaitingResponsesFullDefenceReceived_whenCaseDataAtStateAwaitingResponsesFullDefenceReceived() {
            CaseData caseData = CaseDataBuilder.builder().atStateAwaitingResponseFullDefenceReceived().build();
        ...
        @Test
        void shouldReturnClaimDetailsNotified_whenCaseDataAtStateAwaitingResponsesFullDefenceBothSolicitors1v2() {
            CaseData caseData = CaseDataBuilder.builder()
                .atStateClaimDetailsNotified_1v2_andNotifyBothSolicitors()
                .build();
        ...
        @Test
        void shouldReturnClaimDetailsNotified_whenCaseDataAtStateAwaitingResponsesFullDefenceSingleSolicitorIn1v2() {
            CaseData caseData = CaseDataBuilder.builder()
                .atStateClaimDetailsNotified_1v2_andNotifyOnlyOneSolicitor()
                .build();
        ...
        class DefendantResponseMultiparty {
            ...
            void shouldReturnDivergentResponse_in1v2Scenario_whenOneRespondentSubmitsFullDefenceResponse() {
                ...
                assertThat(stateFlow.getState())
                    .extracting(State::getName)
                    .isNotNull()
                    .isEqualTo(DIVERGENT_RESPOND.fullName());
                assertThat(stateFlow.getStateHistory())
                    .hasSize(10)
                    .extracting(State::getName)
                    .containsExactly(
                        ...
                        PENDING_CLAIM_ISSUED.fullName(), CLAIM_ISSUED.fullName(), CLAIM_NOTIFIED.fullName(),
                        CLAIM_DETAILS_NOTIFIED.fullName(), NOTIFICATION_ACKNOWLEDGED.fullName(),
                        ALL_RESPONSES_RECEIVED.fullName(), DIVERGENT_RESPOND.fullName()
                    );
                verify(featureToggleService).isRpaContinuousFeedEnabled();
                assertThat(stateFlow.getFlags()).hasSize(3).contains(
                    entry("ONE_RESPONDENT_REPRESENTATIVE", false),
