...
import uk.gov.hmcts.reform.civil.model.genapplication.ApplicationType;
import uk.gov.hmcts.reform.civil.model.genapplication.GeneralApplication;
import uk.gov.hmcts.reform.civil.model.genapplication.RespondentOrderAgreement;
...
public class InitiateGeneralApplicationHandler extends CallbackHandler {
    ...
    private CaseData buildCaseData(CaseData.CaseDataBuilder dataBuilder, CaseData caseData) {
        ...
        return dataBuilder
            .generalAppRespondentAgreement(RespondentOrderAgreement.builder().build())
            .generalAppType(ApplicationType.builder().build())
